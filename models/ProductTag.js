...
ProductTag.init(
  {
    ...
    product_id: { // product_id is the id of the product the tag belongs to (INTEGER)
      type: DataTypes.INTEGER, // type is an integer (INTEGER)
      references: { // references the product table
        model: 'product', // reference the product model
        key: 'id' // reference the id field
      }
    },
    tag_id: { // tag_id is the id of the tag (INTEGER)
      type: DataTypes.INTEGER, // type is an integer (INTEGER)
