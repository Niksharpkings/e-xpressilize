...
Category.init(
  // initialize the Category class with the sequelize constructor and the data types from the library (DataTypes) to use in our models (Model) (this is needed for the routes to work)
  {
    ...
    category_name: {
      // category_name is the name of the category (VARCHAR)
